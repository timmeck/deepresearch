"""Auth middleware -- API key protection for DeepResearch.

SECURITY: ALL endpoints require auth when DEEPRESEARCH_API_KEY is set.
...
class AuthMiddleware(BaseHTTPMiddleware):
    """API key middleware. Active when DEEPRESEARCH_API_KEY is set.
